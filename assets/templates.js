...
<div id="v4-comp-1783056651639729" class="lf-component" style="position: absolute; top: 145px; left: 230px; z-index: 1000; transform: none; width: 1180px; height: 80px;">
            <div class="v4-admin-settings-container" data-row-count="2" data-row-height="40" data-row1-label="기간" data-row1-cols="1" data-row1-type="textbox" style="position: relative; width: 100%; height: 100%; box-sizing: border-box; background: #ffffff; border: 1.6px solid rgb(226, 232, 240); border-radius: 8px; font-family: inherit; display: flex; flex-direction: column; overflow: hidden; isolation: isolate; contain: paint; -webkit-mask-image: -webkit-radial-gradient(white, black); mask-image: radial-gradient(white, black); transform: translateZ(0); pointer-events: auto;" data-row2-label="항목명, 상태" data-row2-cols="2" data-row2-type="textbox">
