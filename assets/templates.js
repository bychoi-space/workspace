...
<div class="lf-component" data-resized="true" style="position: absolute; top: 20px; left: 20px; z-index: 1000; transform: none; width: 1560px; height: 40px; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" id="v4-comp-1788326575728-1">
        ...
        <div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div><div class="lf-component" style="position: absolute; top: 800.245px; left: 176px; z-index: 1000; transform: none; width: 600px; height: 60px; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true" id="v4-comp-1788326581857-12">
            ...
            </div><div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div><div class="lf-component" style="position: absolute; top: 805.245px; left: 40px; z-index: 1000; transform: none; height: 50px; color: rgb(0, 0, 0); width: 50px;" data-resized="true" id="v4-comp-1788326581857-13"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="lf-icon" style="width: 100%; height: 100%; padding: 3px; box-sizing: border-box; background-image: none !important; color: rgb(255, 255, 255);"><path d="M15 14c.8-.8 1.5-1.8 1.8-2.9a6 6 0 1 0-9.6 0c.3 1.1 1 2.1 1.8 2.9" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></path><path d="M9 18h6" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></path><path d="M10 22h4" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></path></svg><div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div><div id="group-1788411105421" class="lf-component lf-group" style="position: absolute; left: 791px; top: 800.245px; width: 769px; height: 60px; background: transparent; border-width: medium; border-style: none; border-color: currentcolor; border-image: none; z-index: 1000;"><div class="lf-component v4-text-shape" style="position: absolute; top: 13.5px; left: 60px; width: 99px; height: 33px; z-index: 1001; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" id="v4-comp-1788326581857-14">
        ...
        <div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div><div class="lf-component" data-resized="true" style="position: absolute; top: 0px; left: 169px; z-index: 1000; transform: none; width: 600px; height: 60px; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" id="v4-comp-1788326581857-15">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(255, 255, 255); border-color: transparent; border-top-style: ; border-width: 1.6px !important; border-right-style: ; border-bottom-style: ; border-left-style: ; border-image-source: ; border-image-slice: ; border-image-width: ; border-image-outset: ; border-image-repeat: ; border-radius: 100px !important; display: flex; align-items: center; justify-content: center; color: var(--v4-text-color, #0f172a); overflow: hidden; box-sizing: border-box;">
            ...
            </div><div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div><div class="lf-component" style="position: absolute; top: 5px; left: 0px; z-index: 1000; transform: none; height: 50px; color: rgb(0, 0, 0); width: 50px;" data-resized="true" id="v4-comp-1788326581857-16"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="lf-icon" style="width: 100%; height: 100%; padding: 3px; box-sizing: border-box; background-image: none !important; color: rgb(255, 255, 255);"><path d="M10 2v7.31L4.15 18.5A2 2 0 0 0 5.86 21.5h12.28a2 2 0 0 0 1.71-3L14 9.31V2" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></path><path d="M8.5 2h7" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></path><path d="M7 16h10" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></path></svg><div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div></div>
...
<div id="v4-comp-1788327202432_224160_0" class="lf-component" data-resized="true" style="position: absolute; top: 701px; left: 345px; z-index: 1000; transform: none; width: 260px; height: 50px;">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgba(234, 88, 12, 0.1); border-color: rgb(234, 88, 12); border-top-style: ; border-width: 1.6px !important; border-right-style: ; border-bottom-style: ; border-left-style: ; border-image-source: ; border-image-slice: ; border-image-width: ; border-image-outset: ; border-image-repeat: ; border-radius: 12px; display: flex; align-items: center; justify-content: center; color: var(--v4-text-color, #0f172a); overflow: hidden; box-sizing: border-box;">
                <div contenteditable="true" class="v4-editable-cell" style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 5px 10px; box-sizing: border-box; text-align: center; outline: none; font-weight: 400; font-size: 12px; font-family: inherit; word-break: break-word; overflow-wrap: break-word; white-space: pre-wrap;"></div>
            </div><div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div><div id="v4-comp-1788327209848_278787_0" class="lf-component" data-resized="true" style="position: absolute; top: 701px; left: 670px; z-index: 1000; transform: none; width: 260px; height: 50px;">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgba(234, 88, 12, 0.1); border-color: rgb(234, 88, 12); border-top-style: ; border-width: 1.6px !important; border-right-style: ; border-bottom-style: ; border-left-style: ; border-image-source: ; border-image-slice: ; border-image-width: ; border-image-outset: ; border-image-repeat: ; border-radius: 12px; display: flex; align-items: center; justify-content: center; color: var(--v4-text-color, #0f172a); overflow: hidden; box-sizing: border-box;">
                <div contenteditable="true" class="v4-editable-cell" style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 5px 10px; box-sizing: border-box; text-align: center; outline: none; font-weight: 400; font-size: 12px; font-family: inherit; word-break: break-word; overflow-wrap: break-word; white-space: pre-wrap;"></div>
            </div><div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div><div id="v4-comp-1788327212613_362465_0" class="lf-component" data-resized="true" style="position: absolute; top: 701px; left: 995px; z-index: 1000; transform: none; width: 260px; height: 50px;">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgba(234, 88, 12, 0.1); border-color: rgb(234, 88, 12); border-top-style: ; border-width: 1.6px !important; border-right-style: ; border-bottom-style: ; border-left-style: ; border-image-source: ; border-image-slice: ; border-image-width: ; border-image-outset: ; border-image-repeat: ; border-radius: 12px; display: flex; align-items: center; justify-content: center; color: var(--v4-text-color, #0f172a); overflow: hidden; box-sizing: border-box;">
                <div contenteditable="true" class="v4-editable-cell" style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 5px 10px; box-sizing: border-box; text-align: center; outline: none; font-weight: 400; font-size: 12px; font-family: inherit; word-break: break-word; overflow-wrap: break-word; white-space: pre-wrap;"></div>
            </div><div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div><div id="v4-comp-1788327216646_696926_0" class="lf-component" data-resized="true" style="position: absolute; top: 701px; left: 1320px; z-index: 1000; transform: none; width: 260px; height: 50px;">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgba(234, 88, 12, 0.1); border-color: rgb(234, 88, 12); border-top-style: ; border-width: 1.6px !important; border-right-style: ; border-bottom-style: ; border-left-style: ; border-image-source: ; border-image-slice: ; border-image-width: ; border-image-outset: ; border-image-repeat: ; border-radius: 12px; display: flex; align-items: center; justify-content: center; color: var(--v4-text-color, #0f172a); overflow: hidden; box-sizing: border-box;">
                <div contenteditable="true" class="v4-editable-cell" style="width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 5px 10px; box-sizing: border-box; text-align: center; outline: none; font-weight: 400; font-size: 12px; font-family: inherit; word-break: break-word; overflow-wrap: break-word; white-space: pre-wrap;"></div>
            </div><div class="lf-connector-port port-top" data-side="top"></div><div class="lf-connector-port port-bottom" data-side="bottom"></div><div class="lf-connector-port port-left" data-side="left"></div><div class="lf-connector-port port-right" data-side="right"></div></div>
...
window.LF_TEMPLATES['template_project_summary.html'] = `<!DOCTYPE html>
<html lang="ko" style="--v4-text-color: #0f172a; --v4-font-size: 12px; --v4-font-weight: 400; --v4-font-family: 'Pretendard Variable', Pretendard, -apple-system, BlinkMacSystemFont, system-ui, Roboto, 'Helvetica Neue', 'Segoe UI', 'Apple SD Gothic Neo', 'Noto Sans KR', 'Malgun Gothic', sans-serif; --v4-placeholder-color: #94a3b8;"><head>
    <meta charset="UTF-8">
    <title>과제 개요 및 마일스톤 보고서 - {{PROJECT_NAME}}</title>
...
<body>
    <div class="page" id="canvas-page">
        ...
        <!-- ========================================== -->
        <!-- 헤더 배경 카드 -->
        <div id="v4-hdr-bg" class="lf-component" style="position: absolute; top: 20px; left: 30px; width: 1540px; height: 50px; z-index: 100;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #0f172a; border: 1.6px solid #1e293b; border-radius: 10px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>

        <!-- 헤더 아이콘 박스 -->
        <div id="v4-hdr-icon" class="lf-component" style="position: absolute; top: 31px; left: 45px; width: 28px; height: 28px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #4f46e5; border: 1.6px solid transparent; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: #ffffff; box-sizing: border-box;">
                <span class="material-icons-outlined" style="font-size: 18px;">analytics</span>
            </div>
        </div>

        <!-- 헤더 타이틀 텍스트 -->
        <div id="v4-hdr-title" class="lf-component v4-text-shape" style="position: absolute; top: 31px; left: 83px; width: 320px; height: 25px; z-index: 101; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 3px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(248, 250, 252); font-size: 16px; font-weight: 800; display: block; text-align: left; width: 100%; height: 100%; padding: 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;"><span style="font-size: 16px; color: rgb(248, 250, 252); white-space: nowrap !important;">과제 타이틀 (Project Title)</span></p></div>
        </div>
        ...
        <!-- ========================================== -->
        <!-- 카드 1 전체 배경 -->
        <div id="v4-card1-bg" class="lf-component" style="position: absolute; top: 100px; left: 30px; width: 750px; height: 330px; z-index: 100;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #ffffff; border: 1.6px solid #e2e8f0; border-radius: 12px; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(15, 23, 42, 0.03); box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>

        <!-- 카드 1 아이콘 -->
        <div id="v4-card1-icon" class="lf-component" style="position: absolute; top: 114px; left: 48px; width: 20px; height: 20px; z-index: 101;">
            <svg viewBox="0 0 24 24" fill="none" stroke="#4f46e5" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="lf-icon" style="width: 100%; height: 100%;"><circle cx="12" cy="12" r="10" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></circle><circle cx="12" cy="12" r="6" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></circle><circle cx="12" cy="12" r="2" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></circle></svg>
        </div>

        <!-- 카드 1 타이틀 텍스트 -->
        <div id="v4-card1-title" class="lf-component v4-text-shape" style="position: absolute; top: 112px; left: 74px; width: 80px; height: 25px; z-index: 101; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 3px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(15, 23, 42); font-size: 16px; font-weight: 800; display: block; text-align: left; width: 100%; height: 100%; padding: 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;"><span style="font-size: 16px; white-space: nowrap !important;">과제 목적</span></p></div>
        </div>

        <!-- 카드 1 뱃지 -->
        <div id="v4-card1-badge" class="lf-component" style="position: absolute; top: 113px; left: 663px; width: 95px; height: 24px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #f1f5f9; border: 1.6px solid #cbd5e1; border-radius: 6px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 0 4px;">
                    <p><span style="font-size: 11px; font-weight: 700; color: #475569;">OBJECTIVE</span></p>
                </div>
            </div>
        </div>

        <!-- 카드 1 메인 목표 박스 배경 -->
        <div id="v4-card1-main-bg" class="lf-component" style="position: absolute; top: 150px; left: 48px; width: 710px; height: 50px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #f8fafc; border: 1.6px solid #cbd5e1; border-radius: 8px; display: flex; align-items: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>

        <!-- 카드 1 메인 목표 텍스트 -->
        <div id="v4-card1-main-txt" class="lf-component v4-text-shape" style="position: absolute; top: 160px; left: 62px; width: 450px; height: 21px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 14px; font-weight: 700; color: rgb(15, 23, 42); display: block; text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;"><span style="font-size: 14px; white-space: nowrap !important;">• 과제의 핵심 목표 및 추진 배경을 기술합니다.</span></p></div>
        </div>

        <!-- Item 1: 배경 -->
        <div id="v4-c1-i1-bg" class="lf-component" style="position: absolute; top: 208px; left: 48px; width: 710px; height: 56px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #ffffff; border: 1.6px solid #e2e8f0; border-radius: 8px; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>
        <!-- Item 1: 뱃지 -->
        <div id="v4-c1-i1-badge" class="lf-component" style="position: absolute; top: 222px; left: 62px; width: 150px; height: 30px; z-index: 102; min-width: unset !important; min-height: unset !important; --v4-text-adjust-y: 0px;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(238, 242, 255); border-width: 1.6px !important; border-style: solid; border-color: rgb(199, 210, 254); border-image: none; border-radius: 6px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: flex-start !important; justify-content: center; text-align: left !important; padding: 5px 10px !important; box-sizing: border-box;"><p><strong style="color: rgb(79, 70, 229);">(1) 첫번째 개선사항</strong></p></div>
            </div>
        </div>
        <!-- Item 1: 타이틀 -->
        <div id="v4-c1-i1-title" class="lf-component v4-text-shape" style="position: absolute; top: 225px; left: 230px; width: 110px; height: 21px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 14px; font-weight: 800; color: rgb(30, 41, 59); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">직관적으로 표현</p>
            </div>
        </div>
        <!-- Item 1: 설명 -->
        <div id="v4-c1-i1-desc" class="lf-component v4-text-shape" style="position: absolute; top: 226px; left: 360px; width: 370px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(100, 116, 139); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">세부 개선 내용 및 기대효과를 기술합니다.</p>
            </div>
        </div>

        <!-- Item 2: 배경 -->
        <div id="v4-c1-i2-bg" class="lf-component" style="position: absolute; top: 272px; left: 48px; width: 710px; height: 56px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #ffffff; border: 1.6px solid #e2e8f0; border-radius: 8px; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>
        <!-- Item 2: 뱃지 -->
        <div id="v4-c1-i2-badge" class="lf-component" style="position: absolute; top: 286px; left: 62px; width: 150px; height: 30px; z-index: 102; min-width: unset !important; min-height: unset !important; --v4-text-adjust-y: 0px;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(238, 242, 255); border-width: 1.6px !important; border-style: solid; border-color: rgb(199, 210, 254); border-image: none; border-radius: 6px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: flex-start !important; justify-content: center; text-align: left !important; padding: 5px 10px !important; box-sizing: border-box;"><p><strong style="color: rgb(79, 70, 229);">(2) 두번째 개선사항</strong></p></div>
            </div>
        </div>
        <!-- Item 2: 타이틀 -->
        <div id="v4-c1-i2-title" class="lf-component v4-text-shape" style="position: absolute; top: 289px; left: 230px; width: 110px; height: 21px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 14px; font-weight: 800; color: rgb(30, 41, 59); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">기능 개편 / 추가</p>
            </div>
        </div>
        <!-- Item 2: 설명 -->
        <div id="v4-c1-i2-desc" class="lf-component v4-text-shape" style="position: absolute; top: 290px; left: 360px; width: 370px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(100, 116, 139); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">세부 개선 내용 및 기대효과를 기술합니다.</p>
            </div>
        </div>
        ...
        <!-- Item 3: 배경 -->
        <div id="v4-c1-i3-bg" class="lf-component" style="position: absolute; top: 336px; left: 48px; width: 710px; height: 56px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #ffffff; border: 1.6px solid #e2e8f0; border-radius: 8px; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>
        <!-- Item 3: 뱃지 -->
        <div id="v4-c1-i3-badge" class="lf-component" style="position: absolute; top: 350px; left: 62px; width: 150px; height: 30px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(238, 242, 255); border-width: 1.6px !important; border-style: solid; border-color: rgb(199, 210, 254); border-image: none; border-radius: 6px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; justify-content: center; box-sizing: border-box; align-items: flex-start !important; text-align: left !important; padding: 4px !important;"><p><strong style="color: rgb(79, 70, 229); font-size: 12px;">(3) 세번째 개선사항</strong></p></div>
            </div>
        </div>
        <!-- Item 3: 타이틀 -->
        <div id="v4-c1-i3-title" class="lf-component v4-text-shape" style="position: absolute; top: 353px; left: 230px; width: 110px; height: 21px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 14px; font-weight: 800; color: rgb(30, 41, 59); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">사용자 경험 (UX)</p>
            </div>
        </div>
        <!-- Item 3: 설명 -->
        <div id="v4-c1-i3-desc" class="lf-component v4-text-shape" style="position: absolute; top: 354px; left: 360px; width: 370px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(100, 116, 139); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">세부 개선 내용 및 기대효과를 기술합니다.</p>
            </div>
        </div>
        ...
        <!-- ========================================== -->
        <!-- [3] 우측 상단: 2. 과제 작업 범위 카드           -->
        <!-- ========================================== -->
        <!-- 카드 2 전체 배경 -->
        <div id="v4-card2-bg" class="lf-component" style="position: absolute; top: 100px; left: 820px; width: 750px; height: 330px; z-index: 100;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #ffffff; border: 1.6px solid #e2e8f0; border-radius: 12px; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(15, 23, 42, 0.03); box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>
        <!-- 카드 2 아이콘 -->
        <div id="v4-card2-icon" class="lf-component" style="position: absolute; top: 114px; left: 838px; width: 20px; height: 20px; z-index: 101;">
            <svg viewBox="0 0 24 24" fill="none" stroke="#2563eb" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="lf-icon" style="width: 100%; height: 100%;"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></path></svg>
        </div>
        <!-- 카드 2 타이틀 -->
        <div id="v4-card2-title" class="lf-component v4-text-shape" style="position: absolute; top: 112px; left: 864px; width: 80px; height: 25px; z-index: 101; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 3px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(15, 23, 42); font-size: 16px; font-weight: 800; display: block; text-align: left; width: 100%; height: 100%; padding: 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;"><span style="font-size: 16px; white-space: nowrap !important;">작업 범위</span></p></div>
        </div>
        <!-- 카드 2 뱃지 -->
        <div id="v4-card2-badge" class="lf-component" style="position: absolute; top: 113px; left: 1453px; width: 95px; height: 24px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #f1f5f9; border: 1.6px solid #cbd5e1; border-radius: 6px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 0 4px;">
                    <p><span style="font-size: 11px; font-weight: 700; color: #475569;">SCOPE</span></p>
                </div>
            </div>
        </div>

        <!-- [서브박스 1]: Front UI 개발 (IN SCOPE) -->
        <div id="v4-c2-front-bg" class="lf-component" style="position: absolute; top: 150px; left: 838px; width: 340px; height: 260px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #f8fafc; border: 1.6px solid #cbd5e1; border-radius: 10px; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>
        <div id="v4-c2-front-icon" class="lf-component" style="position: absolute; top: 164px; left: 854px; width: 22px; height: 22px; z-index: 102;">
            <svg viewBox="0 0 24 24" fill="none" stroke="#059669" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="lf-icon" style="width: 100%; height: 100%;"><rect x="5" y="2" width="14" height="20" rx="2" ry="2" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>
        </div>
        <div id="v4-c2-front-title" class="lf-component v4-text-shape" style="position: absolute; top: 162px; left: 882px; width: 105px; height: 22px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 15px; font-weight: 800; color: rgb(15, 23, 42); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">Front UI 개발</p>
            </div>
        </div>
        <div id="v4-c2-front-badge" class="lf-component" style="position: absolute; top: 163px; left: 1074px; width: 90px; height: 24px; z-index: 102;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(16, 185, 129); border-width: 1.6px !important; border-style: solid; border-color: transparent; border-image: none; border-radius: 4px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center;">
                    <p><span style="font-size: 11px; font-weight: 800; color: #ffffff;">IN SCOPE</span></p>
                </div>
            </div>
        </div>
        <div id="v4-c2-front-sub" class="lf-component v4-text-shape" style="position: absolute; top: 204px; left: 854px; width: 200px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; font-weight: 700; color: rgb(4, 120, 87); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">기획 · 디자인 · 퍼블리싱 · 개발</p>
            </div>
        </div>
        <div id="v4-c2-front-div" class="lf-component" style="position: absolute; top: 241px; left: 854px; width: 310px; height: 2px; z-index: 102;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 1px; border-width: 1.6px !important; border-top-style: dashed; border-top-color: rgb(203, 213, 225); background: transparent; box-sizing: border-box;"></div>
        </div>
        <div id="v4-c2-front-txt1" class="lf-component v4-text-shape" style="position: absolute; top: 256px; left: 854px; width: 250px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(51, 65, 85); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">• <strong style="white-space: nowrap !important;">기획 </strong>: 요구사항 정의 및 화면설계서(SB)</p></div>
        </div>
        <div id="v4-c2-front-txt2" class="lf-component v4-text-shape" style="position: absolute; top: 287px; left: 854px; width: 250px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(51, 65, 85); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">• <strong style="white-space: nowrap !important;">디자인 </strong>: PC &amp; Mobile UI 가이드</p></div>
        </div>
        <div id="v4-c2-front-txt3" class="lf-component v4-text-shape" style="position: absolute; top: 318px; left: 854px; width: 250px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(51, 65, 85); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">• <strong style="white-space: nowrap !important;">퍼블리싱 </strong>: 웹 마크업 구현</p></div>
        </div>
        <div id="v4-c2-front-txt4" class="lf-component v4-text-shape" style="position: absolute; top: 349px; left: 854px; width: 250px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(51, 65, 85); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">• <strong style="white-space: nowrap !important;">개발 </strong>: UI 기능 개발</p></div>
        </div>

        <!-- [서브박스 2]: Admin 백오피스 (OUT OF SCOPE) -->
        <div id="v4-c2-admin-bg" class="lf-component" style="position: absolute; top: 150px; left: 1208px; width: 340px; height: 260px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #f8fafc; border: 1.6px solid #e2e8f0; border-radius: 10px; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>
        <div id="v4-c2-admin-icon" class="lf-component" style="position: absolute; top: 164px; left: 1224px; width: 22px; height: 22px; z-index: 102;">
            <svg viewBox="0 0 24 24" fill="none" stroke="#64748b" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="lf-icon" style="width: 100%; height: 100%;"><circle cx="12" cy="12" r="3" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></path></svg>
        </div>
        <div id="v4-c2-admin-title" class="lf-component v4-text-shape" style="position: absolute; top: 162px; left: 1252px; width: 120px; height: 22px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 15px; font-weight: 800; color: rgb(100, 116, 139); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">Admin 백오피스</p>
            </div>
        </div>
        <div id="v4-c2-admin-badge" class="lf-component" style="position: absolute; top: 163px; left: 1429px; width: 105px; height: 24px; z-index: 102;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(148, 163, 184); border-width: 1.6px !important; border-style: solid; border-color: transparent; border-image: none; border-radius: 4px; display: flex; align-items: center; justify-content: center; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center;">
                    <p><span style="font-size: 11px; font-weight: 800; color: #ffffff;">OUT OF SCOPE</span></p>
                </div>
            </div>
        </div>
        <div id="v4-c2-admin-sub" class="lf-component v4-text-shape" style="position: absolute; top: 204px; left: 1224px; width: 150px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; font-weight: 800; color: rgb(185, 28, 28); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">🚫 Admin 개발 없음</p>
            </div>
        </div>
        <div id="v4-c2-admin-div" class="lf-component" style="position: absolute; top: 241px; left: 1224px; width: 310px; height: 2px; z-index: 102;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 1px; border-width: 1.6px !important; border-top-style: dashed; border-top-color: rgb(226, 232, 240); background: transparent; box-sizing: border-box;"></div>
        </div>
        <div id="v4-c2-admin-txt1" class="lf-component v4-text-shape" style="position: absolute; top: 256px; left: 1224px; width: 250px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(100, 116, 139); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">• 백오피스 설정 변경 없음</p></div>
        </div>
        <div id="v4-c2-admin-txt2" class="lf-component v4-text-shape" style="position: absolute; top: 287px; left: 1224px; width: 250px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(100, 116, 139); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">• 기존 API 및 DB 스키마 유지</p></div>
        </div>
        <div id="v4-c2-admin-txt3" class="lf-component v4-text-shape" style="position: absolute; top: 318px; left: 1224px; width: 250px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(100, 116, 139); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">• 추가 어드민 메뉴 생성 불필요</p></div>
        </div>
        <div id="v4-c2-admin-txt4" class="lf-component v4-text-shape" style="position: absolute; top: 349px; left: 1224px; width: 250px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(100, 116, 139); text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">• 프론트 단독 렌더링 방식으로 처리</p></div>
        </div>

        <!-- ========================================== -->
        <!-- [4] 하단 영역: 3. 작업 일정 및 마일스톤 카드      -->
        <!-- ========================================== -->
        <!-- 카드 3 전체 배경 -->
        <div id="v4-card3-bg" class="lf-component" style="position: absolute; top: 470px; left: 30px; width: 1540px; height: 400px; z-index: 100;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #ffffff; border: 1.6px solid #e2e8f0; border-radius: 12px; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(15, 23, 42, 0.03); box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>
        ...
        <!-- 카드 3 아이콘 -->
        <div id="v4-card3-icon" class="lf-component" style="position: absolute; top: 484px; left: 48px; width: 20px; height: 20px; z-index: 101;">
            <svg viewBox="0 0 24 24" fill="none" stroke="#4f46e5" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" class="lf-icon" style="width: 100%; height: 100%;"><rect x="3" y="4" width="18" height="18" rx="2" ry="2" stroke-width="1.6" style="stroke-width: 1.6; vector-effect: non-scaling-stroke;"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
        </div>

        <!-- 카드 3 타이틀 텍스트 -->
        <div id="v4-card3-title" class="lf-component v4-text-shape" style="position: absolute; top: 482px; left: 74px; width: 140px; height: 25px; z-index: 101; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 3px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(15, 23, 42); font-size: 16px; font-weight: 800; display: block; text-align: left; width: 100%; height: 100%; padding: 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;"><span style="font-size: 16px; white-space: nowrap !important;">일정 (Timeline)</span></p></div>
        </div>

        <!-- 일정 안내 박스 배경 -->
        <div id="v4-notice-bg" class="lf-component" style="position: absolute; top: 525px; left: 48px; width: 1500px; height: 36px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: #fffbeb; border: 1.6px solid #fde68a; border-radius: 6px; box-sizing: border-box;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>

        <!-- 일정 안내 텍스트 -->
        <div id="v4-notice-txt" class="lf-component v4-text-shape" style="position: absolute; top: 531px; left: 64px; width: 450px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; font-size: 13px; color: rgb(146, 64, 14); font-weight: 600; display: block; text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;"><p style="white-space: nowrap !important;">⚠️ 본 일정은 <strong style="white-space: nowrap !important;">계획 초안</strong>이며, 상세 작업에 따라 일정 변동 될 수 있습니다.</p></div>
        </div>

        <!-- 간트 헤더 배경 -->
        <div id="v4-gantt-hdr-bg" class="lf-component" style="position: absolute; top: 581px; left: 48px; width: 1500px; height: 34px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(75, 85, 99); border-radius: 6px; box-sizing: border-box; border-width: 1.6px !important;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%;"><p><br></p></div>
            </div>
        </div>

        <!-- 간트 헤더 개별 라벨들 (100% 독립 컴포넌트) -->
        <div id="v4-gantt-th-task" class="lf-component v4-text-shape" style="position: absolute; top: 586px; left: 58px; width: 120px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(248, 250, 252); font-size: 12px; font-weight: 700; text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">작업 구분 (Task)</p>
            </div>
        </div>
        <div id="v4-gantt-th-w1" class="lf-component v4-text-shape" style="position: absolute; top: 586px; left: 360px; width: 110px; height: 24px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(248, 250, 252); font-size: 12px; font-weight: 700; text-align: center; width: 100%; height: 100%; padding: 4px !important;">
                <p>1주차</p>
            </div>
        </div>
        <div id="v4-gantt-th-w2" class="lf-component v4-text-shape" style="position: absolute; top: 586px; left: 576px; width: 116px; height: 24px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(248, 250, 252); font-size: 12px; font-weight: 700; text-align: center; width: 100%; height: 100%; padding: 4px !important;">
                <p>2주차</p>
            </div>
        </div>
        <div id="v4-gantt-th-w3" class="lf-component v4-text-shape" style="position: absolute; top: 586px; left: 796px; width: 124px; height: 24px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(248, 250, 252); font-size: 12px; font-weight: 700; text-align: center; width: 100%; height: 100%; padding: 4px !important;">
                <p>3주차</p>
            </div>
        </div>
        <div id="v4-gantt-th-w4" class="lf-component v4-text-shape" style="position: absolute; top: 586px; left: 1100px; width: 140px; height: 24px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(248, 250, 252); font-size: 12px; font-weight: 700; text-align: center; width: 100%; height: 100%; padding: 4px !important;">
                <p>4~5주차</p>
            </div>
        </div>
        <div id="v4-gantt-th-w5" class="lf-component v4-text-shape" style="position: absolute; top: 586px; left: 1406px; width: 110px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(253, 224, 71); font-size: 12px; font-weight: 800; text-align: center; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">🚀 최종 배포</p>
            </div>
        </div>

        <!-- 간트 트랙 1 (기획): 트랙배경 / 라벨 / 바 -->
        <div id="v4-gt1-track" class="lf-component" style="position: absolute; top: 632px; left: 308px; width: 1240px; height: 38px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(248, 250, 252); border-width: 1.6px !important; border-style: solid; border-color: rgb(226, 232, 240); border-image: none; border-radius: 6px; box-sizing: border-box;"></div>
        </div>
        <div id="v4-gt1-label" class="lf-component v4-text-shape" style="position: absolute; top: 639px; left: 56px; width: 220px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(15, 23, 42); font-size: 13px; font-weight: 700; text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">📋 요구사항 분석 및 기획서 작성</p>
            </div>
        </div>
        <div id="v4-gt1-bar" class="lf-component" style="position: absolute; top: 637px; left: 314px; width: 200px; height: 28px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(79, 70, 229); border-radius: 6px; display: flex; align-items: center; justify-content: center; box-shadow: rgba(79, 70, 229, 0.2) 0px 2px 4px; box-sizing: border-box; border-width: 1.6px !important;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 4px !important;"><p><strong style="color: rgb(255, 255, 255);">기획 (1주차)</strong></p></div>
            </div>
        </div>

        <!-- 간트 트랙 2 (디자인): 트랙배경 / 라벨 / 바 -->
        <div id="v4-gt2-track" class="lf-component" style="position: absolute; top: 676px; left: 308px; width: 1240px; height: 38px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(248, 250, 252); border-width: 1.6px !important; border-style: solid; border-color: rgb(226, 232, 240); border-image: none; border-radius: 6px; box-sizing: border-box;"></div>
        </div>
        <div id="v4-gt2-label" class="lf-component v4-text-shape" style="position: absolute; top: 683px; left: 56px; width: 150px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(15, 23, 42); font-size: 13px; font-weight: 700; text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">🎨 디자인 작업</p>
            </div>
        </div>
        <div id="v4-gt2-bar" class="lf-component" style="position: absolute; top: 681px; left: 534px; width: 200px; height: 28px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(79, 70, 229); border-radius: 6px; display: flex; align-items: center; justify-content: center; box-shadow: rgba(79, 70, 229, 0.2) 0px 2px 4px; box-sizing: border-box; border-width: 1.6px !important;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 4px !important;"><p><strong style="color: rgb(255, 255, 255);">디자인 (2주차)</strong></p></div>
            </div>
        </div>

        <!-- 간트 트랙 3 (퍼블리싱): 트랙배경 / 라벨 / 바 -->
        <div id="v4-gt3-track" class="lf-component" style="position: absolute; top: 720px; left: 308px; width: 1240px; height: 38px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(248, 250, 252); border-width: 1.6px !important; border-style: solid; border-color: rgb(226, 232, 240); border-image: none; border-radius: 6px; box-sizing: border-box;"></div>
        </div>
        <div id="v4-gt3-label" class="lf-component v4-text-shape" style="position: absolute; top: 727px; left: 56px; width: 150px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(15, 23, 42); font-size: 13px; font-weight: 700; text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">💻 퍼블리싱 작업</p>
            </div>
        </div>
        <div id="v4-gt3-bar" class="lf-component" style="position: absolute; top: 725px; left: 758px; width: 200px; height: 28px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(79, 70, 229); border-radius: 6px; display: flex; align-items: center; justify-content: center; box-shadow: rgba(79, 70, 229, 0.2) 0px 2px 4px; box-sizing: border-box; border-width: 1.6px !important;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 4px !important;"><p><strong style="color: rgb(255, 255, 255);">퍼블리싱 (3주차)</strong></p></div>
            </div>
        </div>

        <!-- 간트 트랙 4 (개발): 트랙배경 / 라벨 / 바 -->
        <div id="v4-gt4-track" class="lf-component" style="position: absolute; top: 764px; left: 308px; width: 1240px; height: 38px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(248, 250, 252); border-width: 1.6px !important; border-style: solid; border-color: rgb(226, 232, 240); border-image: none; border-radius: 6px; box-sizing: border-box;"></div>
        </div>
        <div id="v4-gt4-label" class="lf-component v4-text-shape" style="position: absolute; top: 771px; left: 56px; width: 150px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(15, 23, 42); font-size: 13px; font-weight: 700; text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">⚙️ 개발 작업</p>
            </div>
        </div>
        <div id="v4-gt4-bar" class="lf-component" style="position: absolute; top: 769px; left: 970px; width: 400px; height: 28px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(37, 99, 235); border-radius: 6px; display: flex; align-items: center; justify-content: center; box-shadow: rgba(37, 99, 235, 0.2) 0px 2px 4px; box-sizing: border-box; border-width: 1.6px !important;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 4px !important;"><p><strong style="color: rgb(255, 255, 255);">개발 (4~5주차)</strong></p></div>
            </div>
        </div>

        <!-- 간트 트랙 5 (배포): 트랙배경 / 라벨 / 바 -->
        <div id="v4-gt5-track" class="lf-component" style="position: absolute; top: 808px; left: 308px; width: 1240px; height: 38px; z-index: 101;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(248, 250, 252); border-width: 1.6px !important; border-style: solid; border-color: rgb(226, 232, 240); border-image: none; border-radius: 6px; box-sizing: border-box;"></div>
        </div>
        <div id="v4-gt5-label" class="lf-component v4-text-shape" style="position: absolute; top: 815px; left: 56px; width: 150px; height: 20px; z-index: 102; --v4-text-adjust-y: 0px; min-width: unset !important; min-height: unset !important; --v4-text-shape-pad-y: 2px; white-space: nowrap !important;">
            <div class="v4-editable-cell" contenteditable="true" style="outline: none; color: rgb(15, 23, 42); font-size: 13px; font-weight: 700; text-align: left; width: 100%; height: 100%; padding: 2px 3px !important; white-space: nowrap !important;">
                <p style="white-space: nowrap !important;">🚀 최종 배포</p>
            </div>
        </div>
        <div id="v4-gt5-bar" class="lf-component" style="position: absolute; top: 813px; left: 1382px; width: 160px; height: 28px; z-index: 102;" data-resized="true">
            <div class="v4-shape v4-shape-rect" style="width: 100%; height: 100%; background: rgb(217, 119, 6); border-radius: 6px; display: flex; align-items: center; justify-content: center; box-shadow: rgba(217, 119, 6, 0.2) 0px 2px 4px; box-sizing: border-box; border-width: 1.6px !important;">
                <div class="v4-shape-text-content" style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; text-align: center;">
                    <p><span style="font-size: 13px; font-weight: 800; color: #ffffff;">최종 배포</span></p>
                </div>
            </div>
        </div>
...
window.LF_TEMPLATES['project_summary'] = window.LF_TEMPLATES['template_project_summary.html'];
window.LF_TEMPLATES['summary'] = window.LF_TEMPLATES['template_project_summary.html'];
