...
(function() {
    ...
    const initStepperEvents = () => {
        if (window.InspectorAtoms && typeof window.InspectorAtoms.bindStepperEvents === 'function') {
            window.InspectorAtoms.bindStepperEvents();
        }
    };
    initStepperEvents();
    ...
    const initSelectboxEvents = () => {
        if (window.InspectorAtoms && typeof window.InspectorAtoms.bindSelectboxEvents === 'function') {
            window.InspectorAtoms.bindSelectboxEvents();
        }
    };
    initSelectboxEvents();
    ...
    const initFileuploadEvents = () => {
        if (window.InspectorAtoms && typeof window.InspectorAtoms.bindFileuploadEvents === 'function') {
            window.InspectorAtoms.bindFileuploadEvents();
        }
    };
    initFileuploadEvents();
        ...
        const initAlertEvents = () => {
            if (window.InspectorAtoms && typeof window.InspectorAtoms.bindAlertEvents === 'function') {
                window.InspectorAtoms.bindAlertEvents();
            }
        };
        initAlertEvents();
    ...
    const initButtonEvents = () => {
        if (window.InspectorAtoms && typeof window.InspectorAtoms.bindButtonEvents === 'function') {
            window.InspectorAtoms.bindButtonEvents();
        }
    };
    initButtonEvents();
    ...
    const initAccordionEvents = () => {
        if (window.InspectorAccordion && typeof window.InspectorAccordion.bindEvents === 'function') {
            window.InspectorAccordion.bindEvents();
            return;
        }
    };
    initAccordionEvents();
